...
public class Jugador {
	...
	/*
	 * Metodo para formatear la fecha de Nacimiento public String
	 * getFormattedFechaNacimiento() { DateTimeFormatter formatter =
	 * DateTimeFormatter.ofPattern("dd/MM/yyyy"); return
	 * this.fechaNacimiento.format(formatter); }
	 */
